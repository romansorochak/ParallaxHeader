#
#  Be sure to run `pod spec lint ParallaxHeader.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of ParallaxHeader."
  ...
  s.homepage     = "http://EXAMPLE/ParallaxHeader"
